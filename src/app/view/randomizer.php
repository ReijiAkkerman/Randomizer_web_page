                ...
                <div class="languages-additional-languages">
                    ...
                    <div>
                        <div class="languages-additional-languages-list">
                            <button class="languages-additional-languages-list__button">Английский язык</button>
                            <button class="languages-additional-languages-list__button">Японский язык</button>
                            <button class="languages-additional-languages-list__button">
                                <svg viewBox="0 0 32 32">
        ...
        <section class="dashboard">
            ...
            <div class="lists">
                ...
                <div class="lists-combined">
                    ...
                    <button class="lists-combined__button">Обьединенный список</button>
                </div>
                <div class="lists-temporary-split">
                    <button class="lists-temporary-split__button lists_delete-lists">
                        <svg viewBox="0 0 1024 1024">
                            <path d="M764.288 214.592 512 466.88 259.712 214.592a31.936 31.936 0 0 0-45.12 45.12L466.752 512 214.528 764.224a31.936 31.936 0 1 0 45.12 45.184L512 557.184l252.288 252.288a31.936 31.936 0 0 0 45.12-45.12L557.12 512.064l252.288-252.352a31.936 31.936 0 1 0-45.12-45.184z"/>
                        </svg>
                    </button>
                    <p class="lists_title">Разделенные списки</p>
                    <button class="lists-temporary-split__button">Разделенный список</button>
                    <button class="lists-temporary-split__button">Разделенный список</button>
                </div>
                <div class="lists-hard-word">
                    ...
                    <button class="lists-hard-word__button">список трудных слов</button>
                    <button class="lists-hard-word__button">список трудных слов</button>
                </div>
                <div class="lists-word">
                    <p class="lists_title">Списки слов</p>
                    <button class="lists-word__button">список слов</button>
                    <button class="lists-word__button">список слов</button>
                </div>
            </div>
            <div class="filters">
